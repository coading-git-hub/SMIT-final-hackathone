...
const hijabStyles = [
    {
      ...
      description: 'A soft and luxurious silk hijab perfect for formal occasions. Made from premium silk for a smooth texture.',
      imageUrl: '/heejab1.jpeg',
      averageRating: 4.7,
      reviews: [
        { userName: 'Ayesha', rating: 5, text: 'Very comfortable!', createdAt: new Date() }
      ]
    },
    {
      _id: '2',
